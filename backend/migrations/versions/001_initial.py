...
Revision ID: 001
Revises: 
Create Date: 2024-02-23 18:01:55.556157
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('vkid', sa.Integer(), nullable=True))
    ...
    op.create_unique_constraint(None, 'users', ['vkid'])
